export enum ErrorStatusCode {
     ...
     * @constant
     */
    STATUS_PARAMETER_ERROR = 7010,
    /**
     * 傳送資料錯誤
     * @constant
     */
    STATUS_SEND_DATA_ERROR = 7011,
    /**
     * 編號不存在
     * @constant
     */
    STATUS_ID_NOT_EXIST = 7400,
    /**
     * 錯誤
     * @constant
     */
    STATUS_BACK_END_ERROR = 7155,
    /**
     * 登入帳號錯誤
     * @constant
     */
    STATUS_LOGIN_ACCOUNT_ERROR = 7101,
    /**
     * 登入密碼錯誤
     * @constant
     */
    STATUS_LOGIN_PASSWORD_ERROR = 7102,
    /**
     * 帳號停用
     * @constant
     */
    STATUS_ACCOUNT_DISABLE = 7103,
    /**
     * 註冊代理資料錯誤
     * @constant
     */
    STATUS_PROXY_DATA_ERROR = 7120,
    /**
     * 註冊帳號重複
     * @constant
     */
    STATUS_ACCOUNT_REPEAT = 7121,
    /**
     * 修改密碼失敗
     * @constant
     */
    STATUS_MODIFY_PASSWORD_FAIL = 7122,
    /**
     * 查無該使用者
     * @constant
     */
    STATUS_COULD_NOT_FOUND_MEMBER = 7123,
    /**
     * 無會員資料
     * @constant
     */
    STATUS_MEMBER_NOT_EXIST = 7131,
    /**
     * 此俱樂部ID已存在
     * @constant
     */
    STATUS_CLUB_ID_EXIST = 7132,
    /**
     * 查無此俱樂部ID
     * @constant
     */
    STATUS_CLUB_NOT_EXIST = 7133,
    /**
     * 俱樂部無此會員
     * @constant
     */
    STATUS_CLUB_NOT_MEMBER = 7134,
    /**
     * 身分錯誤 ??
     * @constant
     */
    STATUS_IDENTITY_ERROR = 7135,
    /**
     * 會員已存在此俱樂部
     * @constant
     */
    STATUS_CLUB_MEMBER_EXIST = 7136,
    /**
     * 資料庫語法錯誤
     * @constant
     */
    STATUS_SQL_QUERY_ERROR = 7150,
    /**
     * 無圖片資料
     * @constant
     */
    STATUS_IMAGE_NOT_EXIST = 7252,
    /**
     * 此會員無加入任何俱樂部
     * @constant
     */
    STATUS_MEMBER_NOT_JOIN_CLUB = 66666666666666
}
